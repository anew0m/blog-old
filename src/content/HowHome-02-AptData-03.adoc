...
image::img/HowHome/AptData/02/AptDate03/intro-zigbang.png[직방활용사례]
...
image::img/HowHome/AptData/02/AptDate03/data-aptList-01.png[공동주택단지목록API_1]
...
image::img/HowHome/AptData/02/AptDate03/data-aptList-02.png[공동주택단지목록API_2]
...
image::img/HowHome/AptData/02/AptDate03/data-aptList-03.png[공동주택단지목록API_3]
...
image::img/HowHome/AptData/02/AptDate03/data-aptList-04.png[공동주택단지목록API_4]
...
image::img/HowHome/AptData/02/AptDate03/data-aptInfo-01.png[공동주택기본정보API_1]
...
image::img/HowHome/AptData/02/AptDate03/data-aptInfo-02.png[공동주택기본정보API_2]
...
image::img/HowHome/AptData/02/AptDate03/data-aptInfo-03.png[공동주택기본정보API_3]
...
image::img/HowHome/AptData/02/AptDate03/data-aptTrade-01.png[아파트매매실거래상세자료API_1]
...
image::img/HowHome/AptData/02/AptDate03/data-aptTrade-02.png[아파트매매실거래상세자료API_2]
...
image::img/HowHome/AptData/02/AptDate03/data-aptTrade-03.png[아파트매매실거래상세자료API_3]
...
image::img/HowHome/AptData/02/AptDate03/data-bjdCode-01.png[법정동코드_1]

image::img/HowHome/AptData/02/AptDate03/data-bjdCode-02.png[법정동코드_2]
...
image::img/HowHome/AptData/02/AptDate03/data-bjdCode-03.png[법정동코드_3]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-1-01.png[건물DB_1]

건물정보는 건물관리번호가 PK로 구성되어있고,
FK로 추정되는 데이터로 1.법정동코드, 9.도로명코드, 17.읍면동일련번호, 18.행정동코드, 20.우편번호 가 있습니다.


image::img/HowHome/AptData/02/AptDate03/data-roadCode-1-02.png[건물DB_2]

관련지번 정보의 PK는 도로명코드, 지하여부, 건물본번, 건물부번, 지번일련번호 총 5개의 복합키로 구성되어있습니다.
FK로 추정되는 데이터는 1.법정동코드 가 있는것 같습니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-1-03.png[건물DB_3]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-2-01.png[주소DB_1]


도로명주소 정보는 관리번호 라는 인조식별자를 PK로 가지고 있는것 같습니다.
FK는 2.도로명코드와 3.읍면동일련번호를 가지고 있습니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-2-02.png[주소DB_2]


지번(대표지번+관련지번) 정보의 PK는 관리번호, 일련번호 2개의 복합키로 구성되어있습니다.
FK는 1.관리번호와 3.법정동코드를 가지고 있는것 같습니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-2-03.png[주소DB_3]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-2-04.png[주소DB_4]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-3-01.png[사서함주소DB_1]


도로명주소보기 정보의 PK는 건물관리번호로 인조식별자를 PK로 가지고 있는것 같습니다.
FK로 추정되는 데이터는 1.법정동코드, 9.도로명코드, 18.행정동코드, 20.우편번호 가 있는것 같습니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-3-02.png[사서함주소DB_2]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-3-03.png[사서함주소DB_3]


주소DB와 연결할 때는 17개의 속성이 상호 연결되어야 합니다.
건물DB와 차이점으로는 매핑 순번이 다르고 도로번호와 상위도로명번호, 상위도로명을 제외하고 데이터는 동일합니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-3-04.png[사서함주소DB_4]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-4-01.png[위치정보요약DB_1]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-5-01.png[영문주소DB_1]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-6-01.png[내비게이션용DB_1]


지번정보의 PK는 도로명코드, 지하여부, 건물본번, 건물부번, 지번일련번호, 주소관할읍면동코드 총 6개의 복합키로 PK가 정의되어 있습니다.
FK로 추정되는 데이터는 1.법정동코드, 19.건물관리번호 가 있습니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-6-02.png[내비게이션용DB_2]


보조출입구 정보의 PK는 시군구코드, 출입구일련번호 총 2개의 복합키로 PK가 정의되어 있습니다.
FK로 추정되는 데이터는 3.도로명코드, 7.법정동코드 가 있습니다.

image::img/HowHome/AptData/02/AptDate03/data-roadCode-6-03.png[내비게이션용DB_3]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-7-01.png[상세주소DB_1]
...
image::img/HowHome/AptData/02/AptDate03/data-roadCode-8-01.png[ERDDB_1]
